...
```{r set up of edge list , tidy=TRUE}
...
```{r first few plots, echo=TRUE , tidy=TRUE, tidy.opts = list(blank = FALSE, width.cutoff = 60)}
...
```{r Knotengrösse Anpassen gemäss betweenness , tidy=TRUE, tidy.opts = list(blank = FALSE, width.cutoff = 60) }
